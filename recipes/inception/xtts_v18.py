...
DATASETS_CONFIG_LIST = [
    ...
    #             lang="en"),
    get_dataset(manifest_train="data/english/cv-corpus-15.0-2023-09-08/en/manifest_22050sr_partial.json",
                manifest_eval="data/english/cv-corpus-15.0-2023-09-08/en/manifest_22050sr_partial_eval.json",
                d_name="cv_corpus",
                lang="en"),
]
...
XTTS_CHECKPOINT ="/data/asr/workspace/audio/xtts/expmt/xtts/v15/Inception-XTTS-November-10-2023_12+39PM-6f1cba2f/model.pth"  # model.pth file
