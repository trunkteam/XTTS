...
DATASETS_CONFIG_LIST = [
    ...
    get_dataset(manifest_train="data/tts/vo/en/manifest_trn_2.json",
                ...
                d_name="en_vo_2",
                lang="en"),
    get_dataset(manifest_train="data/english/cv-corpus-15.0-2023-09-08/en/manifest_22050sr.json",
                manifest_eval="data/english/cv-corpus-15.0-2023-09-08/en/manifest_22050sr_eval.json",
                d_name="cv_corpus",
                lang="en"),
]
